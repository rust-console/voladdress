...
/// A 3D version of [`VolGrid2d`], where multiple "frames" of memory are present.
///
/// ## Generic Parameters
...
/// * The address space must legally contain `WIDTH * HEIGHT * FRAMES` contiguous
///   values of the `T` type, starting from the base address.
